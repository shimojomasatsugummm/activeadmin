...
module ActiveAdmin
  class Application
    ...
    def attach_reloader
      Jets.application.config.after_initialize do |app|
        unload_active_admin = -> { ActiveAdmin.application.unload! }

        if app.config.reload_classes_only_on_change
          # Jets is about to unload all the app files (e.g. models), so we
        ...
        ActiveSupport::Reloader.to_prepare do
          # Jets might have reloaded the routes for other reasons (e.g.
